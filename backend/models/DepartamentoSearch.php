...
class DepartamentoSearch extends Departamento
{
    ...
    public function rules()
    {
        return [
            ...
            [['departamento', 'descripcion_departamento', 'extension', 'jefe_departamento'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'departamento', $this->departamento])
            ->andFilterWhere(['like', 'descripcion_departamento', $this->descripcion_departamento])
            ->andFilterWhere(['like', 'extension', $this->extension])
            ->andFilterWhere(['like', 'jefe_departamento', $this->jefe_departamento]);
